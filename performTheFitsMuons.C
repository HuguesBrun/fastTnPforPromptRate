...
doFit(TString type, TString nomCut, int ptBin, int etaBin, RooWorkspace *theWorkSpace, float *theEfficiency, float *theEffError){
...
performTheFitsMuons(TString type){
